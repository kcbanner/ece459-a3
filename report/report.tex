...
is faster because we can offload the heavy lifting in the modell::morph method to all eight CPU cores. It is not an 8 times speed-up, as we only made paralell a section that consisted of abut 20\% of the program.
